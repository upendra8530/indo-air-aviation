        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              <li><a href="#" className="hover:text-white transition-colors">Aviation Management</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Cabin Crew Training</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Ground Services</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Pilot Training</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Customer Service</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Aviation Security</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-white/80">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p>1st floor, sayaji plaza, in front of</p>
                  <p>bhandari hospital near sayaji hotel, 452001</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+91-7727057928" className="hover:text-white transition-colors">+91-7727057928</a>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@indoairaviation.edu" className="hover:text-white transition-colors">info@indoairaviation.edu</a>
              </div>
