  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Something went wrong. Please try again or call us at +91-9125115798.",
        variant: "destructive",
      });
    } finally {
          ...
          <div className="bg-white rounded-3xl p-8 shadow-elegant">
            ...
            <div className="mt-6 pt-6 border-t border-border text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <a href="tel:+91-9125115798" className="text-primary font-semibold hover:underline"> +91-9125115798 </a>
              </p>
            </div>
          </div>
        </div>
